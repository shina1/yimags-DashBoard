            ...
            <div class="container">
                ...
                <div class="row">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form action="addfarm.php" method="POST">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" placeholder="Farm no" name="farm" style="border: 1px solid blue;">
                                            </div> <br>
                                       <center><input type="submit" placeholder="submit" style="width: 130px; height: 45px; background:white; border: 1px solid blue; color: blue; border-radius:30px 30px 30px 30px;"></center>
                                    </form>
                    ...
                    <div class="col-xl-12 col-xxl-12"> 
                         <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Select To View A Farm</h4>
                            </div>
                            <div class="card-body">
                                          <div class="container">
        <?php
                    ...
                    <?php 
                        ...
                        ?>
        <button type="button" style="width:100px !important; " class="btn btn-success btn-lg"><a style="color:white; font-size:15px;" href="monthly.php?id=<?php echo $row['id']; ?>"><?php echo $row["farmno"]; ?> </a> </button>
        <?php 
                        }
                         ?>

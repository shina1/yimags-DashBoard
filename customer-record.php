                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="breadcrumb-range-picker">
                            ...
                            <span class="ml-1">Customer Table</span>
                        </div>
                    </div>
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Table</a></li>
                            <li class="breadcrumb-item active"><a href="javascript:void(0)">Customer Table</a></li>
                        </ol>
                    </div>
                </div>
                <!-- row -->
                                ...
                                <div class="table-responsive">
                                    <table id="example" class="display" style="min-width: 845px">
                                        <thead>
                                            <tr>
                                                <th>Customer Id</th>
                                                <th style="color:#6a4419;">Customer Name</th>
			...
			?>
                                        <tbody>
                                                 ...
                                                 <tr class="table-row">
                                                        ...
                                                        <td><button type="button" class="btn btn-success mb-2  ml-2" ><a href="custprofile.php?id=<?php echo $row['id']; ?>">View More</a> </button></td>

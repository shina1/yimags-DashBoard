                                        ...
                                        <table class="table table-striped" id="footable">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>Brand Name</th>
                                                    <!--<th>Quantity</th>-->
                                                    <th data-breakpoints="xs">Cost Price/Bag</th>
                                                    <th data-breakpoints="xs">Total Cost Price</th>
                                ...
                                ?>
                                            <tbody data-expanded="true">
                                                <tr>
                                                    ...
                                                    <td data-title="Price" data-breakpoints="xs"># <?php echo $row['costBag']; ?></td>
                                                    <td data-title="total price" data-breakpoints="xs"># <?php echo $row['totCost']; ?></td>
                                                     <td data-title="Date of transaction" data-breakpoints="xs sm md"><?php echo $row['date'];?></td>
                                                    <!-- <td data-title="Selling Price" data-breakpoints="xs">#30,000</td>
                                                    <td data-title="Number available" data-breakpoints="xs sm">80</td>-->
                                                    ...
                                                    <!-- <td data-title="Buyer Name" data-breakpoints="xs sm md">Mikahilu</td> -->

                        ...
                        <div class="col-lg-12 col-sm-12">
                            <div class="card">
                                <div class="card-header">
                                 ...
                                 <div class="card-body">     
                                            <form style="padding-left:220px;" method="post" action="store.php">
                                                        <div class="row">
                                                                <div class="col-sm-3">
                                                                    <input type="text" name="storeNo" class="form-control" placeholder="Store Number" style="border:1px solid #8490ff;">
                                                                </div>
                                                                <div class="col-sm-3 mt-2 mt-sm-0">
                                                                    <input type="text" name="brandName" class="form-control" placeholder="Product Brand Name" style="border:1px solid #8490ff;;">
                                                                </div>
                                                                <div class="col-sm-3 mt-2 mt-sm-0">
                                                                    <input type="text" name="size" class="form-control" placeholder="size. e.g 2mm" style="border:1px solid #8490ff;">
                                                                </div>
                                                            </div> <br>
                                                                    ...
                                                                    <div class="row">
                                                                            ...
                                                                            <div class="col-sm-4">
                                                                                    <input type="number" name="costBag" class="form-control"   placeholder="Cost Price/Bag" style="border:1px solid #8490ff;">
                                                                            </div>
                                                                        </div>
                                                           <br>
                                                            <div class="row">
                                                                        ...
                                                                        <div class="col-sm-4">
                                                                            <input type="number" name="totCost" class="form-control" placeholder="Total Cost Price" style="border:1px solid #8490ff;">
                                                                        </div>
                                                                        <div class="col-sm-4">
                                                                                <input type="date" name="DOP" class="form-control" placeholder="Date of Purchase" style="border:1px solid #8490ff;">
                                                                            </div>
                                                                            
                                                            </div> <br>
                                                            <div class="row">
                                                                    <div class="col-sm-4">
                                                                            <input type="number" name="noExist" class="form-control" placeholder=" Total Number Of Products/Brand In Store" style="border:1px solid #8490ff;">
                                                                        </div>
                                                                <div class="col-sm-4">
                                                                    <input type="datetime" name="stocker" class="form-control" placeholder="Stocked By ..." style="border:1px solid #8490ff;">
                                                                </div> 
                                                                <div class="col-sm-4">
                                                                    <input type="hidden" name="total" class="form-control" placeholder="Stocked By ..." style="border:1px solid #8490ff;">
                                                                </div> 
                                                            </div><br>
                                                   
                                                   <input type="submit" placeholder="submit" name="submit" style="width: 130px; height: 45px; margin-left:220px; margin-top:50px; background:white; border:1px solid #8490ff;; color: blue; border-radius:30px 30px 30px 30px;">
                                            </form>
                                </div>
                            </div>
                        </div>  

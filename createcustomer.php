                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form action="clients.php" method="POST">
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" name="client" placeholder="Customer's Name" style="border: 1px solid blue;">
                                            </div>
                                           
                                                    <div class="col-sm-4">
                                                            <input type="number" class="form-control" name="phone" placeholder="Customer Phone Number" style="border: 1px solid blue;">
                                                        </div>
                                        </div> <br>
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" name="address" placeholder="Customer Address" style="border: 1px solid blue;">
                                            </div>
                                            <div class="col-sm-4 mt-2 mt-sm-0">
                                                <input type="date" class="form-control" name="date" placeholder="Date of Deposit" style="border: 1px solid blue;">
                                            </div>
                                            <!-- <div class="col-sm-4 mt-2 mt-sm-0">
                                                    <input type="number" class="form-control" placeholder="Customer's Balance" style="border: 1px solid blue;">
                                                </div> -->
                                        </div><br>
                                       <center><input type="submit" placeholder="submit" name="upload" style="width: 130px; height: 45px; background:white; border: 1px solid blue; color: blue; border-radius:30px 30px 30px 30px;"></center>
                                    </form>

        ...
        ***********************************-->
        <div class="content-body">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form action="hatchtable.php" method="POST">
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" placeholder="FARM No...." name="farmno" style="border: 1px solid blue;">
                                            </div>
                                            <div class="col-sm-4 mt-2 mt-sm-0">
                                                <input type="text" class="form-control" placeholder="Type of Fish" name="fish_type" style="border: 1px solid blue;">
                                            </div>
                                            <div class="col-sm-4">
                                                <input type="number" name="no_fish" class="form-control" placeholder="NO. OF FISHES" style="border: 1px solid blue;">
                                            </div>
                                            
                                        </div> <br>
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" placeholder="CUSTOMER NAME" name="cleint_name" style="border: 1px solid blue;">
                                            </div>
                                            <div class="col-sm-4 mt-2 mt-sm-0">
                                                <input type="number" class="form-control" placeholder="COST" name="cost" style="border: 1px solid blue;">
                                            </div>
                                            <div class="col-sm-4">
                                                <input type="date" name="data" class="form-control" placeholder="DATE" style="border: 1px solid blue;">
                                            </div>
                                        </div><br>
                                        <div class="basic-form">
			...
			?>
							                ...
							                <td><?php echo $row["cleint_name"]; ?></td>

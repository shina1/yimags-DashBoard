                                        ...
                                        <table class="table table-bordered verticle-middle table-responsive-sm" >
                                            <thead style="border:1px solid blue;">
                                                <tr>
                                                    <th>Year</th>
                <!--<th>Month</th>-->
                <th>Total Feeds for the year</th>
                <th>Total Mortality for the year</th>
                <th>Total cost for the year</th>
                                                    <th scope="col">Edit</th>
                                                    
                                                </tr>
                                            </thead>
                                            <?php 
$conn=mysqli_connect("localhost","yimalbur_owner","qaz1234wsX","yimalbur_dataBase");



            $sql = "SELECT year(date) as year, sum(cost) as total_amount, sum(feed) as total_feed, SUM(mortality) AS total_mortality
...
group by year(date)";
    ...
    $monthNum  = $row["year"];
    $dateObj   = DateTime::createFromFormat('!Y', $monthNum);
